...
def _test_image_upload_field(app):
    ...
    class TestNoResizeForm(BaseForm):
        upload = ImageUploadField("Upload", base_path=path, endpoint="test")

    class TestAutoResizeForm(BaseForm):
        upload = ImageUploadField("Upload", base_path=path, max_size=(64, 64, True))
